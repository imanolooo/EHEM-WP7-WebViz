...
`, 4736925.556599217, 155794.5915427292, 4254901.407861949));
		...
		this.pois.push(new POI("scaMaria", "Inscription ", `<p style="font-size:14px; font-family:Verdana, sans-serif">SCA MARIA, inscription that identifies the Virgin`, 4736928.709447265, 155789.82446321222, 4254899.393209416));
		...
		this.pois.push(new POI("ox", "The ox, symbol of \n St. Luke the Evangelist", `<p style="font-size:14px; font-family:Verdana, sans-serif">The figure of an ox, also holding a book, is clearly identifiable. This iconography aligns with St. Luke the Evangelist, whose gospel opens with an account of Zechariah's sacrifice. The ox, a traditional symbol of sacrifice, metaphorically suggests the human aspiration for a spiritual life, transcending base animalistic instincts.`, 4736927.384003448, 155794.32320798773, 4254903.170072327));
		this.pois.push(new POI("lion", "The lion, symbol of \n St. Mark the Evangelist", `<p style="font-size:14px; font-family:Verdana, sans-serif">The lion, depicted holding a book, represents St. Mark the Evangelist. The symbolism draws from the Gospel of St. Mark, which begins with the narrative of St. John the Baptist in the wilderness. The lion's portrayal, embodying strength and nobility, serves as a metaphorical prefiguration of Christ.`, 4736928.641813144, 155793.59030907456, 4254902.063322327));
		this.pois.push(new POI("eagle", "The eagle, symbol \n of St. John", `<p style="font-size:14px; font-family:Verdana, sans-serif">The depiction of an eagle symbolizing St. John the Evangelist can only be surmised. `, 4736928.124939195, 155790.8495206062, 4254902.603389485));
		this.pois.push(new POI("angel", "The angel, symbol \n of St. Matthew", `<p style="font-size:14px; font-family:Verdana, sans-serif">Unfortunately, the representation of the angel, an emblem of St. Matthew the Evangelist, has faded into decay and is no longer recognizable.`, 4736927.090062655, 155791.89067310668, 4254903.903101254));
		this.pois.push(new POI("dextera1", "The Hand of God \n in the window", `<p style="font-size:14px; font-family:Verdana, sans-serif">The Hand of God alludes to the physical and spiritual enlighten of the place. `, 4736927.363361403, 155794.51194876738, 4254901.611712034));
		...
		this.pois.push(new POI("Lamb_inscription", "Inscription mentioning \n the Lamb", `<p style="font-size:14px; font-family:Verdana, sans-serif">
The inscription [AGNVS DEI QVI T]OL[L]ITP[E] / [CCAT]A MON / DI alludes to the presence of the Lamb, which would be accompanying it. The text has liturgical significance, as it evokes the Roman Mass prayer of the Agnus dei: "Lamb of God, who takes away the sin of the world, have mercy on us"). At the same time, it recalls the words of John the Baptist when he saw Jesus: "Behold the Lamb of God, who takes away the sin of the world.(Jo. 1,29)`, 4736928.086128469, 155793.70484611992, 4254902.240684626));
		this.pois.push(new POI("scales", "The scales of the \n Apocalyptic knight", `<p style="font-size:14px; font-family:Verdana, sans-serif">Accoding to Rev. 6,5, this horseman symbolizes scarcity on earth.`, 4736927.789278445, 155792.03589676268, 4254900.393080054));
		...
		this.pois.push(new POI("torchOff", "Extinguished torch", `<p style="font-size:14px; font-family:Verdana, sans-serif">Extinguished torch with empty oil lamp.`, 4736928.760462913, 155790.19493122064, 4254897.58198414));
		this.pois.push(new POI("keys", "Saint Peter keys", `<p style="font-size:14px; font-family:Verdana, sans-serif">Saint Peter holding the keys to the Heavenly Kingdom, promised to him by Christ (Matt. 16:19).`, 4736923.499620871, 155794.00936657196, 4254905.26135514));
	}
